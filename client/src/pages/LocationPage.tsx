    ...
    <div className="min-h-screen bg-[#F7F0DF] text-[#00174A] py-14 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
      ...
      <ScrollReveal direction="up" duration={0.8}>
        <div className="text-center max-w-3xl mx-auto border-b border-[#10184A]/15 pb-8 space-y-3">
          <span className="text-[10px] font-sans font-bold uppercase tracking-[0.2em] text-[#00174A] block">
            Prime Highway Location · Hassan, Karnataka
          </span>
          <h1 className="editorial-section-title text-[#00174A]">Location & Directions</h1>
          <p className="font-sans text-xs sm:text-sm text-[#667085] max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="pt-6 grid grid-cols-1 md:grid-cols-3 gap-4 max-w-5xl mx-auto">
            ...
            <a
              ...
              className="flex items-center justify-between gap-2 px-3.5 sm:px-4 py-3 sm:py-3.5 rounded-xl bg-[#00174A] text-white shadow-sm hover:bg-[#10184A] hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 group overflow-hidden"
            >
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-white/10 flex items-center justify-center text-white shrink-0 group-hover:scale-105 transition-transform">
                <MapPin size={17} className="fill-white text-[#00174A]" />
              </div>
      ...
      <ScrollReveal direction="up" duration={0.85}>
        <div className="bg-white p-8 sm:p-10 rounded-2xl border border-[#10184A]/15 shadow-sm space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#10184A]/15 pb-5">
            <div>
              <span className="text-[10px] font-sans font-bold uppercase tracking-[0.2em] text-[#00174A] block mb-1">
                Hassan & Regional Connectivity
              </span>
              <h2 className="editorial-section-title text-[#00174A]">Key Distances & Proximities</h2>
            </div>
          ...
          <ScrollRevealGroup staggerDelay={0.08} className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <ScrollRevealItem key={idx}>
                ...
                >
                  <div className="space-y-1">
                    ...
                    <h4 className="text-sm font-serif font-bold text-[#00174A]">{item.destination}</h4>
                  </div>
                  <div className="text-right shrink-0 pl-3">
                    <span className="text-sm font-sans font-bold text-[#00174A] block">{item.distance}</span>
                    <span className="text-[10px] font-sans text-[#667085]">{item.duration}</span>
                  </div>
                </div>
              </ScrollRevealItem>
            ))}
