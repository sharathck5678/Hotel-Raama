    ...
    <div className="min-h-screen bg-[#f7f7f2] text-[#333333] py-14 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
        ...
        <ScrollReveal direction="left" duration={0.85} className="lg:col-span-5 h-full">
          <div className="bg-[#47614d] text-[#f7f7f2] p-7 sm:p-9 rounded-2xl border border-[#f7f7f2]/15 flex flex-col justify-between shadow-lg space-y-8 h-full">
        ...
        <ScrollReveal direction="right" duration={0.85} className="lg:col-span-7 h-full">
          <div className="bg-[#f7f7f2] rounded-2xl overflow-hidden border border-[#cbc0ad] shadow-lg flex flex-col min-h-[460px] h-full">
