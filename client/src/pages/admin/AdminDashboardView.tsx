  ...
  return (
    <div className="space-y-6 sm:space-y-8 text-[#333333]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
        <div className="bg-[#47614d] text-[#f7f7f2] p-4 sm:p-6 rounded-sm border border-[#f7f7f2]/15 space-y-2.5 sm:space-y-3 shadow-md hover:border-[#d9b57d]/40 transition-all">
        ...
        <div className="bg-[#47614d] text-[#f7f7f2] p-4 sm:p-6 rounded-sm border border-[#f7f7f2]/15 space-y-2.5 sm:space-y-3 shadow-md hover:border-emerald-400/40 transition-all">
          <div className="flex justify-between items-center text-[#f7f7f2]/70 text-xs font-sans font-bold uppercase tracking-wider">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
        ...
        <div className="lg:col-span-2 bg-[#47614d] text-[#f7f7f2] p-4 sm:p-6 rounded-sm border border-[#f7f7f2]/15 space-y-4 shadow-md">
        ...
        <div className="bg-[#47614d] text-[#f7f7f2] p-4 sm:p-6 rounded-sm border border-[#f7f7f2]/15 space-y-4 shadow-md">
