  ...
  return (
    <div className="space-y-4 sm:space-y-6 text-[#333333]">
      <div className="border-b border-[#cbc0ad] pb-4">
        <h1 className="text-xl sm:text-2xl font-serif text-[#333333]">Administrative Audit Trail</h1>
          ...
          <table className="w-full text-left min-w-[620px]">
            <thead className="bg-[#f7f7f2]/10 text-[#d9b57d] uppercase font-bold border-b border-[#f7f7f2]/15 text-[10px] tracking-wider">
              <tr>
                ...
                <th className="py-3 px-3.5">Admin Email</th>
            ...
            <tbody className="divide-y divide-[#f7f7f2]/10 text-[#f7f7f2]/80">
              {logs.length === 0 ? (
                <tr>
                  <td colSpan={5} className="py-12 text-center text-[#f7f7f2]/50 text-xs">
                ...
                logs.map((log) => (
                  <tr key={log._id} className="hover:bg-[#f7f7f2]/5 transition-colors">
                    <td className="py-3 px-3.5 text-[#f7f7f2]/50 font-mono text-[11px] whitespace-nowrap">
                      {new Date(log.createdAt).toLocaleString()}
                    </td>
                    <td className="py-3 px-3.5 font-semibold text-white whitespace-nowrap">{log.adminEmail}</td>
                    ...
                    <td className="py-3 px-3.5 font-mono text-[#d9b57d] whitespace-nowrap">{log.entity}</td>
                    <td className="py-3 px-3.5 text-[10px] font-mono text-[#f7f7f2]/70 max-w-xs break-all">
