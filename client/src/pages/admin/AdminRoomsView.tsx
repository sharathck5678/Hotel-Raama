      ...
      <ScrollRevealGroup staggerDelay={0.03} className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2.5 sm:gap-4">
        {rooms.map((room) => (
          <ScrollRevealItem key={room._id}>
            <div
              className="bg-[#47614d] text-[#f7f7f2] p-3 sm:p-4 rounded-sm border border-[#f7f7f2]/15 space-y-2.5 sm:space-y-3 shadow-md flex flex-col justify-between font-sans text-xs h-full"
            >
              <div>
