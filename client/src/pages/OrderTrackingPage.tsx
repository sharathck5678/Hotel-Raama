...
export const OrderTrackingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F7F0DF] text-[#00174A] py-16 px-6 max-w-lg mx-auto space-y-6">
      {/* Card Header */}
      <ScrollReveal direction="up" duration={0.85}>
        ...
        <div>
          <span className="text-[10px] font-sans text-[#D6B369] font-bold uppercase tracking-[0.2em] block">
          ...
          <span className="inline-block mt-2 px-3 py-1 bg-white/10 border border-white/20 text-[#D6B369] text-[10px] font-sans font-bold uppercase tracking-wider rounded-sm">
            {order.status}
          </span>
        </div>
              ...
              <div key={step.key} className="flex items-center gap-3">
                <div
                  className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold border transition-all ${
                    isCompleted
                      ? 'bg-[#D6B369] text-[#00174A] border-[#D6B369]'
                      : 'bg-white/5 text-white/40 border-white/15'
                  } ${isCurrent ? 'animate-pulse ring-2 ring-[#D6B369]' : ''}`}
                >
                  <Icon size={15} />
                </div>
        ...
        <div className="p-5 bg-white/5 rounded-sm border border-white/15 text-left space-y-3 text-xs font-sans">
          <span className="text-[10px] font-bold text-[#D6B369] uppercase tracking-wider block">Ordered Items</span>
          ...
          <div className="pt-3 border-t border-white/10 flex justify-between font-bold text-sm text-[#D6B369]">
        ...
        <div>
          {order.paymentStatus === 'PAID' ? (
            <button
              ...
              className="w-full py-4 bg-[#D6B369] text-[#00174A] hover:bg-[#E8C56A] text-xs font-sans font-bold uppercase tracking-wider rounded-sm flex items-center justify-center gap-2 transition-all shadow-md cursor-pointer active:scale-[0.99]"
            >
              <Download size={15} /> Download Digital Receipt (PDF)
            </button>
          ) : (
            <div className="w-full p-4 bg-white/10 border border-[#D6B369]/30 rounded-sm text-center space-y-1">
              <span className="text-[#D6B369] text-[10px] font-sans font-bold uppercase tracking-wider block">
                🔒 Payment Pending
              </span>
