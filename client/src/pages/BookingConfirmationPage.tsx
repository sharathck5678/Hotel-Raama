...
export const BookingConfirmationPage: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-[70vh] flex items-center justify-center bg-[#F7F0DF] text-[#00174A]">
  ...
  if (!booking) {
    return (
      <div className="min-h-[70vh] bg-[#F7F0DF] flex flex-col items-center justify-center text-center p-6">
  ...
  return (
    <div className="min-h-screen bg-[#F7F0DF] text-[#00174A] py-20 max-w-3xl mx-auto px-6">
        ...
        <div className="bg-[#00174A] text-[#FAF9F6] border border-white/20 rounded-sm p-8 sm:p-12 space-y-10 shadow-2xl">
          ...
          <div className="p-6 bg-white/5 rounded-sm border border-white/15 space-y-4 font-sans text-xs">
            <div className="flex justify-between items-center pb-4 border-b border-white/10">
              <div>
                ...
                <span className="text-xl font-serif font-bold text-[#D6B369]">{booking.bookingId}</span>
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <button
              ...
              className="w-full py-4 rounded-sm bg-[#D6B369] text-[#00174A] hover:bg-[#E8C56A] font-sans font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 transition-all shadow-md cursor-pointer active:scale-[0.99]"
            >
